...
(function () {
  ...
  function patchBundleSource(source) {
    var parts = [
      ...
      // where it sits, what it can read, what is in the way, what is done.
      // Decisions follow what was built -- both are settled, and neither
      // belongs between the goal and the blockers standing in front of it.
